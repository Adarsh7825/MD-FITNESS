    ...
    <button className="h-[650px] w-[350px] ">
      ...
      <div className="h-[75px] w-full  flex flex-col items-center">
        ...
        <div className="flex gap-1">
          <button
            data-color="red"
            className={`p-[2px] border ${color == "red" ? "" : "border-transparent"
              }`}
          ...
          <button
            data-color="yellow"
            className={`p-[2px] border ${color == "yellow" ? "" : "border-transparent"
              }`}
            onClick={(e) => handleColorSelection(e)}
          >
            <div
          ...
          <button
            data-color="brown"
            className={`p-[2px] border ${color == "brown" ? "" : "border-transparent"
              }`}
            onClick={(e) => handleColorSelection(e)}
          >
            <div
          ...
          <button
            data-color="gray"
            className={`p-[2px] border ${color == "gray" ? "" : "border-transparent"
              }`}
            onClick={(e) => handleColorSelection(e)}
          >
            <div
