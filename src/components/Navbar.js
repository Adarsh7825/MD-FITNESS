    ...
    <>
      ...
      >
        <button
          ...
          tabIndex={0}
          className="h-24 w-48 relative font-bold text-2xl"
          onClick={() => {
        ...
        <div className="lg:ml-[10%] flex gap-2 sm:gap-6 md:gap-12 lg:gap-20 md:text-sm lg:text-lg">
          <button
            className="text-lg hover:text-white hover:border-b-2 border-orange-600 transition-all duration-50 [text-shadow:_0_1px_1px_rgb(0_0_0_/_100%)]"
      ...
      <nav
        id="mobile-nav"
        className={`flex flex-col fixed sm:hidden px-10 text-gray-300 gap-5 z-50 w-screen bg-black overflow-hidden ${mobileNavToggle ? "h-full" : "h-20"
      ...
      >
        ...
        <div
          className={`lg:ml-[10%] flex flex-col gap-10 text-[1.5em] justify-start child:flex child:uppercase overflow-y-scroll ${mobileNavToggle ? "" : "hidden h-0"
            } `}
        >
          <button className="hover:text-white hover:border-b-2 border-orange-600 transition-all duration-50 [text-shadow:_0_1px_1px_rgb(0_0_0_/_100%)] ">
            <Link href="/">Home</Link>
